...
<body>
  ...
  <div class="interpret">
    ...
    Download these files from <a href='https://github.com/uzuuzuhonpo/uzuroaster' target='_blank'>GitHub</a> and upload them below :<br><br>
		<table><tr><td>&nbsp;&nbsp;Artisan_sample.ino.bin </td><td>&nbsp;&nbsp; (UZ-01 Firmware)</td></tr>
		<tr><td>&nbsp;&nbsp;index.html </td><td>&nbsp;&nbsp; (URC (WebUI) )</td></tr></table>
  </div>
